...
| §8.2 | `catch` de captura de IP silencioso | ✅ | `capturarIP()` agora loga `console.warn` com o erro antes de retornar vazio |
...
| ✅ 4 | ~~**Log no `catch` de IP**~~ — `console.warn` em `capturarIP()` | Plano §8.2 | — |
...
| 2026-06-27 | IP silencioso §8.2 corrigido: `catch` de `capturarIP()` agora loga `console.warn` com o erro |
