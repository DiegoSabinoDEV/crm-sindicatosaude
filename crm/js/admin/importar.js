...
function normalizarCampos(linha) {
  const mapa = {
    ...
    position: 'cargo',
    job_title: 'cargo',
    'segunda empresa': 'segunda_empresa',
    'segunda empresa saude': 'segunda_empresa',
    'outra empresa': 'segunda_empresa'
  }
...
export function gerarModeloCSV() {
  ...
  const exemplos = [
    [
      ...
      'Clínica XYZ — Auxiliar de Enfermagem'
    ]
  ]
